...
contract Crowdsale is Context, ReentrancyGuard {
     ...
     * @param _softCap Amount of wei raised to have a succcessful crowdsale
     * @param _hardCap Amount of wei raised to have a succcessful crowdsale
     */
    constructor (uint256 _rate, address payable _wallet, IERC20 _token, uint256 _softCap, uint256 _hardCap) {
        require(_rate > 0, "Crowdsale: rate is 0");
        require(_softCap > 0, "Crowdsale: hard cap is 0");
